...
public class QuizSetupActivity extends AppCompatActivity {
    ...
    private void setupClickListeners() {
        btn10Questions.setOnClickListener(v -> startQuiz(10));
        btn15Questions.setOnClickListener(v -> startQuiz(15));
        btn20Questions.setOnClickListener(v -> startQuiz(20));
        btn30Questions.setOnClickListener(v -> startQuiz(30));
    }
